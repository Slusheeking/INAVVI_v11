...
def stop_unified_system(force=False):
    ...
    try:
        ...
        system_running = redis_client.exists("system:status") and redis_client.hget(
        ...
        if system_running:
            ...
            while time.time() - start_time < timeout:
                if not redis_client.exists("system:status") or redis_client.hget("system:status", "running") != "true":
