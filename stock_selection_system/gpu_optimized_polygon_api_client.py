...
REDIS_PASSWORD = os.environ.get(
    'REDIS_PASSWORD', 'trading_system_2025')  # Added default password
REDIS_USERNAME = os.environ.get('REDIS_USERNAME', 'default')  # Added username
    ...
    def __init__(self, host=REDIS_HOST, port=REDIS_PORT, db=REDIS_DB, ttl=CACHE_TTL):
        ...
        try:
            self.redis_client = redis.Redis(
                ...
                port=self.port,
                db=self.db,
                username=REDIS_USERNAME,  # Added username
                password=REDIS_PASSWORD,  # Added password
                socket_timeout=5,
