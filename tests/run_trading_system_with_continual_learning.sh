#!/bin/bash
# Run Trading System with Continual Learning
# This script starts the integrated trading system with continual learning enabled
...
# Always enable continual learning
ARGS="$ARGS --enable-continual-learning"
...
echo "Starting Integrated Trading System with Continual Learning..."
echo "Redis: $REDIS_HOST:$REDIS_PORT/$REDIS_DB"
echo "GPU Acceleration: $USE_GPU"
echo "Log Level: $LOG_LEVEL"
echo "Continual Learning: Enabled"
...
python -m tests.trading_system $ARGS
